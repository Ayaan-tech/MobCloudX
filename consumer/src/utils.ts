...
export const brokersEnv = process.env.KAFKA_BROKERS || 'localhost:9092'
...
export const MONGO_URI = 'mongodb+srv://amjadquasmi_db_user:lOkiYzI0dzIS1tgw@cluster0.6yieivd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
